...
def plot_2d_contour(args, surf_file, surf_name='train_loss', vmin=0.01, vmax=10, vlevel=0.5, show=False):
    ...
    fig.savefig(surf_file + '_' + surf_name + '_2dcontour_' + args.partition + '.pdf', dpi=300,
                bbox_inches='tight', format='pdf')

    fig = plt.figure()
    filename = surf_file + '_' + surf_name + '_2dcontourf_' + args.partition + '.pdf'
    print(filename)
    ...
    sns_plot.get_figure().savefig(surf_file + '_' + surf_name + '_2dheat_' + args.partition + '.pdf',
    ...
    fig.savefig(surf_file + '_' + surf_name + '_3dsurface' + args.partition +'.pdf', dpi=300,
                bbox_inches='tight', format='pdf')
