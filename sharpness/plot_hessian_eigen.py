...
from plot_surface import name_surface_file, setup_surface_file, setup_dataloader
...
if __name__ == '__main__':
    ...
    dataloader = setup_dataloader(args, rank)
    ...
    if args.disaggregated:
        ...
        crunch_hessian_eigs(surf_file, net, w, s, d, dataloader, comm, rank, args)
